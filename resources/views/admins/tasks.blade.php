...
<div class="container">
    ...
    @endif
    <div>
        <a href="{{url('/admins/tasks/reg')}}" class="btn btn-primary">Add Task</a>
    </div>
    <!-- Default box -->
<div class="card mt-2">
          ...
          <tbody>
            ...
            <tr>
                ...
                <td class="project-actions text-right">
                    <a class="btn btn-info btn-sm" href="{{url('/tasks/editView/'.$task['task_id'])}}">
                        <i class="fas fa-pencil-alt">
                        </i>
                        Edit
                    </a>
                    <a class="btn btn-danger btn-sm mt-2" href="{{url('/tasks/delete/'.$task['task_id'])}}">
