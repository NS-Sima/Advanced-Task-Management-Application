...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{url('/users/provide/comment')}}" class="nav-link">Provide comments</a>
      </li>
    </ul>
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <a href="{{url('/users/view/comments')}}" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
          ...
          <a href="{{url('/users/view/comments')}}" class="dropdown-item dropdown-footer">Click to read</a>
        </div>
      </li>
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            ...
            <div class="dropdown-divider"></div>
            <a href="{{url('/users')}}" class="dropdown-item dropdown-footer">Home</a>
        </div>
        </li>
    </ul>
  </nav>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="{{url('/users')}}" class="brand-link">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="{{url('/users')}}" class="d-block">@yield('userLoged')</a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
            ...
            <ul class="nav nav-treeview">
                <li class="nav-item">
                <a href="{{url('/users/teams/list')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{url('/users/tasks/list')}}" class="nav-link">
              <i class="nav-icon fa fa-tasks"></i>
              {{-- List of tasks including a link --}}
              <p>
                Individual task
              </p>
            </a>
